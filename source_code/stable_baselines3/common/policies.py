...
class SACActor(BasePolicy):
    ...
    def get_action_dist_params(self, obs: th.Tensor) -> Tuple[th.Tensor, th.Tensor, Dict[str, th.Tensor]]:
        ...
        log_std = th.clamp(log_std, SAC_LOG_STD_MIN, SAC_LOG_STD_MAX)
...
class SACCnnPolicy(SACPolicy):
    ...
    def __init__(
        ...
        super(SACCnnPolicy, self).__init__(
            observation_space,
            action_space,
            lr_schedule,
            net_arch,
...
class SACMultiInputPolicy(SACPolicy):
    """
    Policy class (with both actor and critic) for SAC.
    ...
    def __init__(
        ...
        super(SACMultiInputPolicy, self).__init__(
            observation_space,
            action_space,
            lr_schedule,
            net_arch,
...
class TD3Policy(BasePolicy):
    ...
    def make_actor(self, features_extractor: Optional[BaseFeaturesExtractor] = None) -> TD3Actor:
        actor_kwargs = self._update_features_extractor(self.actor_kwargs, features_extractor)
...
class TD3CnnPolicy(TD3Policy):
    ...
    def __init__(
        ...
        super(TD3CnnPolicy, self).__init__(
            observation_space,
            action_space,
            lr_schedule,
            net_arch,
...
class TD3MultiInputPolicy(TD3Policy):
    ...
    def __init__(
        ...
        super(TD3MultiInputPolicy, self).__init__(
            observation_space,
            action_space,
            lr_schedule,
            net_arch,
