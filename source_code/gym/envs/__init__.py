...
register(
    id='InvertedPendulumSwingupBulletEnvNoisy-v0',
    entry_point='pybullet_envs.gym_pendulum_envs:InvertedPendulumSwingupNoisyBulletEnv',
    max_episode_steps=1000,
    #reward_threshold=800.0,
)

register(
    id='InvertedDoublePendulumBulletEnvNoisy-v0',
    entry_point='pybullet_envs.gym_pendulum_envs:InvertedDoublePendulumNoisyBulletEnv',
...
register(
    id='PendulumNoisy-v0',
    entry_point='gym.envs.classic_control:PendulumNoisyEnv',
    max_episode_steps=1000,
)
...
register(
    id='HumanoidBalance-v0',
    entry_point='gym.envs.mujoco:HumanoidBalanceEnv',
    max_episode_steps=1000,
)
register(
    id='AcrobotMuJoCo-v0',
